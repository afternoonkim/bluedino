        ...
        <div className="bd-container bd-section">
          <section className="bd-card bd-card-padding">
            ...
            <p className="bd-text-main mt-4">
              반도체 관련주, AI 관련주, 배당주 같은 검색어로 들어오시면 보통 종목 목록이 한꺼번에 쏟아져 정리하기 어렵습니다. BlueDino 산업·테마 가이드는 같은 반도체라도 메모리·HBM·파운드리·장비·PCB로 sub-sector를 나누고, 같은 AI라도 반도체·소프트웨어·인프라·서비스로 가치사슬 단계를 나눠서 비교할 수 있도록 비교할 수 있게 구성했습니다.
            </p>
