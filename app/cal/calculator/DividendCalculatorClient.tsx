      ...
      <div className="bd-container space-y-8">
            ...
            <div ref={resultRef} id="capture-root" className="space-y-6">
              ...
              <CalculatorInfoSection
                ...
                faqs={[
                  ...
                  {
                    q: "실제 투자 결과와 완전히 같나요?",
                    a: "아니요. 실제 세금, 배당 정책 변경, 주가 변동, 환율, 수수료 등은 달라질 수 있어 참고용으로 보는 흐름이 현실적입니다.",
                  },
                ]}
              />
            </div>
        ...
        <CalculatorSeoContent
          sections={[
            {
              title: "배당 계산기란?",
              body: "배당 계산기는 보유 수량, 주가, 배당수익률을 기준으로 예상 배당금과 장기 투자 흐름을 확인할 때 사용하는 도구입니다. 현금으로 받을 때와 재투자할 때의 차이를 비교하기에 적합합니다.",
            },
            {
              title: "어떻게 계산하나요?",
              body: "초기 보유 주식 수와 주당 가격으로 시작 자산을 계산하고, 연 배당률과 배당 성장률, 주가 성장률, 투자 기간, 세율을 반영해 매년 배당 흐름을 시뮬레이션합니다.",
            },
            {
              title: "이런 경우에 활용하면 적합합니다",
              body: "월배당 ETF, 고배당주, 배당 성장주를 장기 보유할 때 예상 현금흐름을 확인하거나 DRIP 전략이 실제로 얼마나 차이를 만드는지 비교할 때 유용합니다.",
            },
            {
              title: "자주 헷갈리는 포인트",
              body: "배당수익률이 높다고 해서 실제 수익이 항상 큰 것은 아닙니다. 세금, 재투자 여부, 주가 성장률, 추가 매수 여부에 따라 결과가 크게 달라질 수 있습니다.",
            },
          ]}
        />
      </div>
