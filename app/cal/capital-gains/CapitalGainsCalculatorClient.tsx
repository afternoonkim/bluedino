      ...
      <div className="bd-container space-y-8">
        ...
        <CalculatorSeoContent
          sections={[
            {
              title: "해외주식 양도세 계산기란?",
              body: "해외주식 양도세 계산기는 여러 종목의 매수·매도 차익과 비용을 합산해 예상 과세표준과 세금을 확인하는 도구입니다. 달러 거래와 환율까지 함께 반영할 수 있다는 점이 먼저 볼 지점입니다.",
            },
            {
              title: "어떻게 계산하나요?",
              body: "각 거래의 매수금액, 매도금액, 수수료, 필요경비를 입력하고 USD 거래라면 매수·매도 환율을 반영해 원화 기준 손익을 계산합니다. 이후 기본공제와 세율을 적용해 예상 세액을 추정합니다.",
            },
            {
              title: "이런 경우에 활용하면 적합합니다",
              body: "연말에 해외주식 손익을 정리할 때, 여러 종목을 매도하기 전에 세금 영향을 미리 보고 싶을 때, 환율 변화가 손익에 얼마나 영향을 주는지 확인할 때 유용합니다.",
            },
            {
              title: "자주 헷갈리는 포인트",
              body: "양도차익은 단순 달러 기준이 아니라 원화 환산 기준으로 계산됩니다. 또 손실 종목과 이익 종목의 통산 여부, 기본공제 적용 방식, 실제 신고 자료와의 차이도 함께 확인해야 합니다.",
            },
          ]}
        />
      </div>
