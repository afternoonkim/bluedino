...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
            { question: "캐피탈 할부와 은행 자동차 대출 중 어느 쪽이 유리한가요?", answer: "은행 자동차 대출이 보통 금리가 낮지만 심사 기준이 까다롭고, 캐피탈 할부는 빠른 승인이 장점입니다. 본인 신용점수와 차량 가격에 따라 다르므로 두 곳 모두 견적을 받아보시는 것이 부담을 줄일 수 있습니다." },
