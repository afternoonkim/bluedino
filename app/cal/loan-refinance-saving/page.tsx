...
const faqSchema = {
  ...
  mainEntity: [
            ...
            { question: "변동금리 → 고정금리 갈아타기는 손익을 어떻게 봐야 하나요?", answer: "현재 변동금리가 높고 향후 금리 하락이 예상된다면 변동 유지가 유리하고, 금리 상승 우려가 크다면 고정으로 갈아타기가 유리합니다. \"본인 현금흐름 안정성\"을 우선 기준으로 삼는 것이 안전합니다." },
