...
const faqSchema = {
  ...
  mainEntity: [
            ...
            { question: "5년 만기 전에 해지하면 어떻게 되나요?", answer: "특별 사유(혼인·출산·실직·해외 이주·천재지변 등)가 아닌 일반 중도해지 시 정부 매칭금과 비과세 혜택이 환수되어 일반 적금과 비슷한 수준으로 떨어집니다. 5년 묶을 수 있는 자금만 가입하시는 것이 부담을 줄일 수 있습니다." },
