...
const faqSchema = {
  ...
  mainEntity: [
            ...
            { question: "자녀 적금에 들어간 자금에 세금이 부과되나요?", answer: "자녀 명의 적금 이자는 일반 적금과 같이 15.4% 과세됩니다. 다만 미성년 자녀에게 증여한 자금이 10년 합산 2천만 원 이내라면 증여세가 없습니다. ISA는 자녀가 가입 연령과 소득 요건을 충족하는 시점에 별도로 검토하는 방식이 적합합니다." },
