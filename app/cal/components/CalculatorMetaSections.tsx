  ...
  return (
    <div className="bd-container-narrow bd-section space-y-6">
      <section className="bd-card-soft bd-card-padding">
        <h2 className="bd-title-md">계산 기준과 정확도</h2>
        <div className="mt-4 flex flex-wrap gap-2 text-xs font-semibold text-slate-300">
          <span className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-cyan-200">정확도: {accuracyLevel}</span>
