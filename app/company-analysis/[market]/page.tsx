        ...
        <div className="bd-container bd-section">
          ...
          <section className="bd-card-soft bd-card-padding">
            ...
            <p className="bd-text-main mt-4">
              ...
              {market.key === "korea"
                ? " 매출 구조, 산업 위치, 실적 변수, 밸류에이션 부담, 리스크 요인을 사용자가 한 흐름으로 이해할 수 있도록 정리했습니다. 코스피·코스닥 상장사 중 거래량과 시가총액이 큰 기업을 우선 다루며, 산업 분류와 사업 모델 차이까지 함께 비교할 수 있도록 구성되어 있습니다."
                : " 사업 모델, 매출 구성, 경쟁 구도, 환율과 금리에 대한 민감도, 밸류에이션 부담, 리스크 요인을 사용자가 한 흐름으로 이해할 수 있도록 정리했습니다. 미국주식 주요 기업을 거래소(NASDAQ·NYSE)별로 다루며, 빅테크부터 헬스케어·금융·소비재·산업재까지 폭넓게 비교할 수 있습니다."}
            </p>
