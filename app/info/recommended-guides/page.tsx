...
export const metadata: Metadata = {
  title: "추천 금융 가이드 | 처음 보면 좋은 투자·절세 가이드 | BlueDino",
  description:
    "ISA, IRP, 연금저축, 대출, 해외주식 세금처럼 처음 보면 헷갈리는 금융 주제를 계산기와 함께 순서대로 볼 수 있는 추천 금융 가이드입니다.",
  alternates: { canonical: "/info/recommended-guides" },
  openGraph: {
    title: "추천 금융 가이드 | BlueDino",
    description: "처음 보면 좋은 투자·절세·대출 가이드와 관련 계산기를 한곳에서 확인하세요.",
    url: "https://bluedino.kr/info/recommended-guides",
    siteName: "BlueDino",
    locale: "ko_KR",
    type: "website",
  },
