...
const sections = [
  ...
  },
  {
    title: "3. 정확성과 최신성",
    body:
      "BlueDino는 정보의 정확성과 가독성을 높이기 위해 노력하지만, 법령·세제·대출 규제·상품 조건은 언제든 바뀔 수 있습니다. 최종 결정 전에는 반드시 공식 자료와 금융회사 안내를 별도로 확인해야 합니다.",
  },
  {
    title: "4. 계산기 결과의 한계",
    body:
  ...
  },
  {
    title: "5. 책임의 한계",
    body:
      "이용자가 BlueDino의 정보를 참고해 내린 투자, 대출, 절세, 매수·매도, 자산배분, 계약 관련 의사결정의 결과는 이용자 본인의 책임입니다. BlueDino는 참고 정보 제공 범위를 넘어서는 개별 결과를 보장하지 않습니다.",
  },
  {
    title: "6. 서비스 변경과 업데이트",
    body:
      "BlueDino는 서비스 품질 개선을 위해 페이지 구성, 계산기 입력 항목, 설명 문구, 링크 구조를 사전 고지 없이 변경할 수 있습니다. 다만 정책 문서 성격의 변경은 가능한 범위에서 페이지 내에 반영합니다.",
  },
  {
      ...
      <div className="bd-container-narrow bd-section">
        <section className="bd-card bd-card-padding">
          ...
          <p className="bd-text-main mt-4">
            ...
            그리고 BlueDino가 어디까지 책임을 지는지 명확하게 안내하기 위해 마련되었습니다.
          </p>
        </section>
