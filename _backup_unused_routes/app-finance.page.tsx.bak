  ...
  return (
    <div className="bd-page">
      <div className="bd-container bd-section">
        ...
        <section className="bd-card bd-card-padding">
          <span className="bd-badge">활용 팁</span>
          <h2 className="bd-title-lg mt-4">금융 가이드를 더 잘 활용하는 방법</h2>
          <div className="bd-list mt-4">
            <div className="bd-list-item">먼저 질문 허브에서 현재 고민과 가장 가까운 주제를 찾습니다.</div>
            <div className="bd-list-item">그다음 계산기로 숫자를 직접 넣어보고, 결과 해석 문단까지 함께 확인합니다.</div>
            <div className="bd-list-item">마지막으로 투자 기초 가이드나 계좌별 세금정보 페이지에서 제도 흐름을 다시 정리하면 이해가 훨씬 선명해집니다.</div>
          </div>
        </section>
